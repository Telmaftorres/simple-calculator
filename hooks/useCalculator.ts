...
export function useCalculator(
  ...
  const {
    ...
    isMultiProduct, products, activeProductIndex, hasDossierFee, hasFournituresEmb, hasPalette, cumulerTemps, showMargeCommerciale, showMargeSopano,
  ...
  const costResult = calculateCosts({
    ...
    varnishMlPerPlate: isMultiProduct ? 0 : varnishMlPerPlate,
    ...
    hasBE, beTimeMinutes, batTimeMinutes, hasDossierFee, hasFournituresEmb, hasPalette,
  ...
  const { isServing, handleSave, handleSaveProd, handleSaveActuals } = useSaveHandlers({
    ...
    hasDossierFee, hasFournituresEmb, hasPalette, cumulerTemps, isMultiProduct, products, showMargeCommerciale, showMargeSopano,
  ...
  return {
    ...
    varnishMlPerPlate, setVarnishMlPerPlate: (v: number) => setField('varnishMlPerPlate', v),
