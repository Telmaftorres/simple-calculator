...
export async function seedSettings(prisma: PrismaClient, companyId: number): Promise<void> {
  ...
  const settings = [
    ...
    { key: 'MATERIAL_MARGIN_Q1_P1', value: String(MATERIAL_MARGIN_Q1_P1), label: 'Coeff matière · 1-5 ex · ≤8 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q1_P2', value: String(MATERIAL_MARGIN_Q1_P2), label: 'Coeff matière · 1-5 ex · 8-20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q1_P3', value: String(MATERIAL_MARGIN_Q1_P3), label: 'Coeff matière · 1-5 ex · >20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q2_P1', value: String(MATERIAL_MARGIN_Q2_P1), label: 'Coeff matière · 6-50 ex · ≤8 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q2_P2', value: String(MATERIAL_MARGIN_Q2_P2), label: 'Coeff matière · 6-50 ex · 8-20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q2_P3', value: String(MATERIAL_MARGIN_Q2_P3), label: 'Coeff matière · 6-50 ex · >20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q3_P1', value: String(MATERIAL_MARGIN_Q3_P1), label: 'Coeff matière · 51-200 ex · ≤8 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q3_P2', value: String(MATERIAL_MARGIN_Q3_P2), label: 'Coeff matière · 51-200 ex · 8-20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q3_P3', value: String(MATERIAL_MARGIN_Q3_P3), label: 'Coeff matière · 51-200 ex · >20 €/m²', unit: 'x' },
    { key: 'MATERIAL_MARGIN_Q4_P1', value: String(MATERIAL_MARGIN_Q4_P1), label: 'Coeff matière · >201 ex · ≤8 €/m²', unit: 'x' },
